...
year: 2023
venue: 'Transactions on Multimedia (TMM)'
paperurl: 'https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=10368362'
citation: 'Camuffo, E., Michieli, U., & Milani, S. (2023). "Learning from Mistakes: Self-Regularizing Hierarchical Representations in Point Cloud Semantic Segmentation." <i>Transactions on Multimedia (TMM)</i>, 25(1), 567-578.'
bib: "@article{camuffo2023leak,
  ...
  booktitle = {Transactions on Multimedia (TMM)},
  year = {2023}
}"
---
